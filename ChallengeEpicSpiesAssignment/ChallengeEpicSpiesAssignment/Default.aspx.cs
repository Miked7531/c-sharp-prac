...
namespace ChallengeEpicSpiesAssignment
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Page.MaintainScrollPositionOnPostBack = true; already set this in web.config file for all files
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //if > 21 days than add $1000
            if (totalDurationOfAssignment.TotalDays > 21)
            {
                totalCost += 1000.0;
            }

            resultLabel.Text = String.Format("Assignment of {0} to assignment {1} is authorized. Budget total: {2:C}", codeNameTextBox.Text, newAssignmentTextBox.Text, totalCost);
            ...
            {
                resultLabel.Text = "Error: Must allow atleast two between previous assignment and new assignment.";
